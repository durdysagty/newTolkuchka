...
namespace newTolkuchka.Models.Migs
{
    ...
    [Migration("20230430210718_CustomerGuid")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("newTolkuchka.Models.Article", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("newTolkuchka.Models.CustomerGuid", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("newTolkuchka.Models.Heading", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("newTolkuchka.Models.HeadingArticle", b =>
                {
                    ...
                    b.HasKey("HeadingId", "ArticleId");

                    b.HasIndex("ArticleId");

                    b.ToTable("HeadingArticles");
                });
            ...
            modelBuilder.Entity("newTolkuchka.Models.Invoice", b =>
                {
                    ...
                    b.Property<Guid?>("CustomerGuidId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("newTolkuchka.Models.Model", b =>
                {
                    ...
                    b.HasIndex("LineId", "TypeId", "BrandId", "Name")
                        .IsUnique()
            ...
            modelBuilder.Entity("newTolkuchka.Models.Promotion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("newTolkuchka.Models.PromotionProduct", b =>
                {
            ...
            modelBuilder.Entity("newTolkuchka.Models.HeadingArticle", b =>
                {
                    b.HasOne("newTolkuchka.Models.Article", "Article")
                        .WithMany("HeadingArticles")
                        .HasForeignKey("ArticleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("newTolkuchka.Models.Heading", "Heading")
                        .WithMany("HeadingArticles")
            ...
            modelBuilder.Entity("newTolkuchka.Models.Invoice", b =>
                {
                    ...
                    b.HasOne("newTolkuchka.Models.CustomerGuid", "CustomerGuid")
                        .WithMany("Invoices")
                        .HasForeignKey("CustomerGuidId");
            ...
            modelBuilder.Entity("newTolkuchka.Models.PromotionProduct", b =>
                {
                    ...
                    b.HasOne("newTolkuchka.Models.Promotion", "Promotion")
                        .WithMany("PromotionProducts")
